...
//문자열을 "" 또는 ''로 묶어 표현한다.
console.log('() 안의 값을 브라우저의 console 창에 출력해 준다.');

var x = 10;
console.log(x);
console.log(''); //줄바꿈

console.warn('경고 메세지가 필요한 경우');
console.error('에러 메세지가 필요한 경우');
console.info('안내 메세지가 필요한 경우');
console.log('');
...
//"",''을 내부에서 이스케이프 문자 없이 한번만 교차 사용이 가능
console.log("Hello I'm SHIN");
console.log('Hello I am "SHIN"');
console.log('');
